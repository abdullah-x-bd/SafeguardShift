...
def main()->None:
    ...
    if row.get("validation_regime")!="triangulated_synthetic_construct_validation":errors.append("wrong validation regime")
    ...
    freeze=Path("v2/FREEZE_MANIFEST.json")
    panel=Path("v2/configs/validation_panel_v2.json")
